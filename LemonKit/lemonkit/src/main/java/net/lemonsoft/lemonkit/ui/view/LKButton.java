...
/**
 * LemonKit UI Button - 对系统的Button进行强化、扩展
 * Created by lemonsoft on 2017/2/1.
 */

public class LKButton extends Button implements LKUIView {
    ...
    public LKButton(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public LKButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
